...
\section{Pengembangan Desain}
    Pada hakikatnya, \textit{resource allocator} adalah sebuah perangkat lunak dapat dipasang di mana saja
    Terdapat 2 hal yang patut dipertimbangkan dalam pemilihan desain sistem, yakni bahasa pemrograman dan algoritma komputasi.
    Pemilihan 2 hal tersebut harus mempertimbangkan spesifikasi yang sebelumnya sudah disebutkan yakni sistem harus dapat berjalan di bawah 1 detik
    Lebih lanjut mengenai pemilihan bahasa pemrograman dan algoritma komputasi akan dibahas padan bagian berikut.
    \subsection{Alternatif Bahasa Pemrograman}
        ...
        Beberapa bahasa pemrograman dibuat hanya untuk kasus tertentu. Setelah melakukan beberapa studi literatur, penulis menyimpulkan 2 bahasa pemrograman
        ...
        terinterpretasi [17]. Tidak seperti bahasa lainnya, Python memiliki struktur data yang dinamis,
        sehingga memudahkan developer dalam mengembangkan aplikasi yang membutuhkan waktu
        pengembangan yang cepat. Python dikembangkan pertama kali dikembangkan oleh Guido van
        ...
        Dari kedua hal tersebut, dapat diketahui bahwa bahasa pemgrograman yang dipilih adalah python karena mendukung scientific computing
